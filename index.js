 ...
 * @returns {returnExemple} an object ready to be used with node-minecraft-protocol
 */
function parse(message, acceptAndChar = false) {
...
module.exports = { parse, colorCodes }